        ...
        for(let i in Game.constructionSites){
            switch(Game.constructionSites[i].structureType){
                ...
                case STRUCTURE_EXTENSION:
                    ...
                    break;
                case STRUCTURE_LINK:
                    if(!Memory.construction.link[i]){
                        Memory.construction.link[i] = {};
                    }
                    if(!Memory.construction.link[i].builder){
                        Memory.construction.link[i].builder = [];
                    }
                    break;
                case STRUCTURE_STORAGE:
                    if(!Memory.construction.storage[i]){
                        Memory.construction.storage[i] = {};
                    }
                    if(!Memory.construction.storage[i].builder){
                        Memory.construction.storage[i].builder = [];
                    }
                    break;
